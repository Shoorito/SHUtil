...
XML 데이터를 주로 다루며, 압축, 암호화, I/O 기능과 같이 개발에서 일반적으로 쓰일 수 있는 편의성 기능들을 내포하고 있습니다

현재 구현되어 있는 기능은 다음과 같습니다
+ **XML 데이터 기반 Localization 데이터 관리 기능**
+ **XML 데이터 기반 데이터 매니저 기능**
+ **LZF 기반 데이터 압축 기능**
+ **SHA-1 기반 데이터 암호화/복호화 기능**
